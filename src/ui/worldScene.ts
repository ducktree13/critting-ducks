...
export function initWorldScene(el: HTMLElement): void {
  el.innerHTML = `
    ...
    >
      ...
      <g class="scene-stars">
        <circle cx="120" cy="90" r="9" fill="var(--scene-detail)"/>
        <circle cx="150" cy="70" r="6" fill="var(--scene-detail)"/>
        <circle cx="95" cy="60" r="4.5" fill="var(--scene-detail)"/>
        <circle cx="180" cy="55" r="3" fill="var(--scene-detail)" class="twinkle" style="animation-delay:0.3s"/>
        <circle cx="260" cy="110" r="2.6" fill="var(--scene-detail)"/>
        <circle cx="340" cy="70" r="3.4" fill="var(--scene-detail)" class="twinkle" style="animation-delay:1.1s"/>
        <circle cx="420" cy="130" r="2.2" fill="var(--scene-detail)"/>
        <circle cx="510" cy="60" r="3" fill="var(--scene-detail)"/>
        <circle cx="600" cy="95" r="2.4" fill="var(--scene-detail)" class="twinkle" style="animation-delay:2.0s"/>
        <circle cx="700" cy="50" r="3.2" fill="var(--scene-detail)"/>
        <circle cx="790" cy="120" r="2.6" fill="var(--scene-detail)"/>
        <circle cx="880" cy="70" r="3" fill="var(--scene-detail)" class="twinkle" style="animation-delay:0.7s"/>
        <circle cx="960" cy="110" r="2.2" fill="var(--scene-detail)"/>
        <circle cx="1050" cy="60" r="3.4" fill="var(--scene-detail)"/>
        <circle cx="1130" cy="100" r="2.6" fill="var(--scene-detail)" class="twinkle" style="animation-delay:1.6s"/>
        <circle cx="1220" cy="55" r="3" fill="var(--scene-detail)"/>
        <circle cx="1300" cy="120" r="2.4" fill="var(--scene-detail)"/>
        <circle cx="1380" cy="75" r="3.2" fill="var(--scene-detail)" class="twinkle" style="animation-delay:2.4s"/>
        <circle cx="1450" cy="115" r="2.4" fill="var(--scene-detail)"/>
        <circle cx="1520" cy="65" r="3" fill="var(--scene-detail)"/>
