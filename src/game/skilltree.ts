...
const PASSIVE2_NODES = act2Chain("passive2", [
  ...
  { id: "p2_xp3", name: "Boundless Knowledge", desc: "+30% XP", effect: { kind: "stat", stat: "xpMult", mult: 1.3 } },
  ...
  { id: "p2_crit", name: "Universal Fortune", desc: "+5% crit chance", effect: { kind: "stat", stat: "critChance", add: 0.05 } },
